...
- (void)resetKeychainItem
{
    ...
    else if (_keychainData)
    {
        ...
        __unused OSStatus errorcode = SecItemDelete((__bridge CFDictionaryRef)tmpDictionary);
...
- (void)writeToKeychain {
                            ...
                            (CFTypeRef *)&attributes) == noErr)
    {
        ...
        __unused OSStatus errorcode = SecItemUpdate(
    ...
    else
    {
        ...
        __unused OSStatus errorcode = SecItemAdd(
