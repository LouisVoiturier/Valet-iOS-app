...
-(void) goToHomeViewController
{
    ...
    // CGIA WARNING
    //    MainViewController* homeController = [sb instantiateViewControllerWithIdentifier:@"HomeViewController"];
                             ...
                             completion:^(User *user, NSHTTPURLResponse *httpResponse, NSError *error)
         {
             ...
             else
             {
                 ...
                 if (user.email)
                 {
                     ...
                     // CGIA DEBUT TEST DOWNLOAD phone
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SignInTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell"];
...
{
    SignInTableViewCell  *cellSelected = [tableView cellForRowAtIndexPath:indexPath];
